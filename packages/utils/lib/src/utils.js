...
exports.remove = exports.copy = exports.createDir = exports.update = exports.updateChanges = exports.getParentFolder = void 0;
const fs_1 = require("fs");
const path_1 = require("path");
const getParentFilePath = (filename) => path_1.resolve(exports.getParentFolder(), filename);
...
exports.copy = (fileDir, fileName) => {
    try {
        fs_1.copyFileSync(path_1.resolve(fileDir, fileName), getParentFilePath(fileName));
    }
    catch (err) {
        return;
    }
